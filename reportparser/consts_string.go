...
func _() {
	...
	// Re-run the stringer command to generate them again.
	var x [1]struct{}
	_ = x[MainItemTagInput-32]
	_ = x[MainItemTagOutput-36]
	_ = x[MainItemTagFeature-44]
	_ = x[MainItemTagCollection-40]
	_ = x[MainItemTagEndCollection-48]
	_ = x[GlobalItemTagUsagePage-1]
	_ = x[GlobalItemTagLogicalMinimum-5]
	_ = x[GlobalItemTagLogicalMaximum-9]
	_ = x[GlobalItemTagPhysicalMinimum-13]
	_ = x[GlobalItemTagPhysicalMaximum-17]
	_ = x[GlobalItemTagUnitExponent-21]
	_ = x[GlobalItemTagUnit-25]
	_ = x[GlobalItemTagReportSize-29]
	_ = x[GlobalItemTagReportID-33]
	_ = x[GlobalItemTagReportCount-37]
	_ = x[GlobalItemTagPush-41]
	_ = x[GlobalItemTagPop-45]
	_ = x[LocalItemTagUsage-2]
	_ = x[LocalItemTagUsageMinimum-6]
	_ = x[LocalItemTagUsageMaximum-10]
	_ = x[LocalItemTagDesignatorIndex-14]
	_ = x[LocalItemTagDesignatorMinimum-18]
	_ = x[LocalItemTagDesignatorMaximum-22]
	_ = x[LocalItemTagStringIndex-30]
	_ = x[LocalItemTagStringMinimum-34]
	_ = x[LocalItemTagStringMaximum-38]
	_ = x[LocalItemTagDelimiter-42]
}

const _ItemTag_name = ""
